            ...
            <div id="f1">
              ...
              <div id="page">
                <span>
                  ...
                  <a href="javascript:void(0)" @click="befpage(),findfuzz();">上一页</a>
                  <a href="javascript:void(0)" @click="laspage(),findfuzz();">下一页</a>
                </span>
              </div>
            </div>
            <div id="box">
...
export default {
        ...
        //         this.$axios({
        //             method:"GET",
        //             url:"http://www.wxhwg.com:8080/mock/api/product/search",
        //             params:{
        //                 name:this.fuzzname
        //             }
        //         }).then(response=>{
