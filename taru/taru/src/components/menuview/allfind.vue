            ...
            <div id="f1">
              ...
              <div id="page">
                <span>
                  ...
                  <a href="javascript:void(0)" @click="befpage(),findall();">上一页</a>
                  <a href="javascript:void(0)" @click="laspage(),findall();">下一页</a>
                </span>
              </div>
            </div>
            <div id="box">
...
export default {
        ...
        methods:{
           ...
           findall: function() {
            this.$axios({
                method: "GET",
                url: "http://localhost:8080/myproject/api/product/productList",
                params: {
                pageNum: this.page,
                pageSize: 24
                }
